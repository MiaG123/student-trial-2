...
function createFallingItem() {
        ...
        fallingItem.style.top = `${Math.random() * -50 - 10}vh`; // Adjust the value for a higher initial position
...
<!-- Add an audio element for the background music -->
    <audio id="gamemusic" loop>
        <source src="download.html" type="audio/mp3">
    </audio>
