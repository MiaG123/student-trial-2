...
<head>
   ...
   <style>
       ...
       .calculator-number {
           background-color: #ADD8E6; /* light blue for numbers */
           color: white;
       }
       .calculator-operation {
           background-color: #FFFFFF; /* white for operations */
           color: white;
       }
       .calculator-clear,
       .calculator-equals {
           background-color: #90EE90; /* light green for clear and equals buttons */
           color: white;
       }
</style>
